...
export function AddTurf() {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      setError(err.message || "Failed to create turf. Backend API not available.");
    } finally {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 h-auto p-1 bg-muted/50">
            ...
            <TabsTrigger value="details" className="py-2.5">Details & Rules</TabsTrigger>
            <TabsTrigger value="pricing" className="py-2.5">Pricing & Hours</TabsTrigger>
            <TabsTrigger value="media" className="py-2.5">Photos</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="basic" className="mt-6 space-y-6">
            <Card className="border-border/50">
              <CardHeader>
                ...
                <CardDescription>The core details about your turf.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="name">Turf Name *</Label>
                  <Input id="name" placeholder="e.g., Green Arena" {...register("name", { required: true })} />
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="contactNumber" type="tel" placeholder="+91 9876543210" {...register("contactNumber", { required: true })} />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email">Business Email</Label>
                    <Input id="email" type="email" placeholder="contact@greenarena.com" {...register("email")} />
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="details" className="mt-6 space-y-6">
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="location" placeholder="Street, City, State, ZIP" {...register("location", { required: true })} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="coordinates">Google Maps Link / Coordinates</Label>
                  <Input id="coordinates" placeholder="https://maps.google.com/..." {...register("coordinates")} />
                </div>
              </CardContent>
            </Card>
            ...
            <div className="flex justify-between">
              ...
              <Button type="button" onClick={() => setActiveTab("pricing")}>Next Step</Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="pricing" className="mt-6 space-y-6">
            <Card className="border-border/50">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2 max-w-xs">
                  ...
                  <Input id="price" type="number" placeholder="800" {...register("price", { required: true })} />
                </div>
            ...
            <Card className="border-border/50">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-4">You can configure detailed time slots and availability blocks from the Time Slot Management page after creating the turf.</p>
            ...
            <div className="flex justify-between">
              ...
              <Button type="button" onClick={() => setActiveTab("media")}>Next Step</Button>
            </div>
          </TabsContent>
          ...
          <TabsContent value="media" className="mt-6 space-y-6">
            <Card className="border-border/50">
              <CardHeader>
                ...
                <CardDescription>Upload high-quality images of your turf</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="flex justify-between">
              <Button type="button" variant="outline" onClick={() => setActiveTab("pricing")}>Previous</Button>
