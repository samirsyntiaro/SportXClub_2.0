...
export function HeroBackground() {
  ...
  useEffect(() => {
    ...
    if (!ctx) return;
    let W: number, H: number, time = 0, raf: number;
 
    class Particle {
      x = 0; y = 0; r = 0; vx = 0; vy = 0; alpha = 0; life = 0; maxLife = 0; green = true;
      constructor(rand: boolean) { this.reset(rand); }
      reset(rand: boolean) {
    ...
    function drawField() {
      ...
      const stripeW = W / 10;
      for (let i = 0; i < 10; i++) {
        ctx!.fillStyle = i % 2 === 0 ? "rgba(34,197,94,0.08)" : "rgba(34,197,94,0.04)";
        ctx!.fillRect(i * stripeW, 0, stripeW, H);
      }

      ctx!.strokeStyle = "rgba(34,197,94,0.35)";
      ctx!.lineWidth = 1.2;
      const mx = W * 0.07, my = H * 0.06;
      ...
      const bw = W * 0.16, bh = H * 0.42, sw2 = W * 0.07, sh = H * 0.22;
